...
CustomCursor tinygo_clang_getTranslationUnitCursor(CXTranslationUnit tu);
unsigned tinygo_clang_visitChildren(CustomCursor parent, CXCursorVisitor visitor, CXClientData client_data);
CXString tinygo_clang_getCursorSpelling(CustomCursor c);
enum CXCursorKind tinygo_clang_getCursorKind(CustomCursor c);
CXType tinygo_clang_getCursorType(CustomCursor c);
CustomCursor tinygo_clang_getTypeDeclaration(CXType t);
CXType tinygo_clang_getTypedefDeclUnderlyingType(CustomCursor c);
CXType tinygo_clang_getCursorResultType(CustomCursor c);
int tinygo_clang_Cursor_getNumArguments(CustomCursor c);
CustomCursor tinygo_clang_Cursor_getArgument(CustomCursor c, unsigned i);

int tinygo_clang_globals_visitor(CustomCursor c, CustomCursor parent, CXClientData client_data);
int tinygo_clang_struct_visitor(CustomCursor c, CustomCursor parent, CXClientData client_data);
*/
import "C"
...
func tinygo_clang_globals_visitor(c, parent C.CustomCursor, client_data C.CXClientData) C.int {
...
func tinygo_clang_struct_visitor(c, parent C.CustomCursor, client_data C.CXClientData) C.int {
